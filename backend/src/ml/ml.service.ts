...
export class MlService {
    ...
    async trainModel() {
        ...
        const dataset = [[10.5, 65, 9, 4563000], [8.5, 75, 8, 5190000], [7.5, 85, 9, 2381000], [8.0, 75, 9, 3450000], [10.0, 65, 8, 4117000], [9.5, 70, 9, 3338000], [9.0, 65, 8, 2924000], [8.8, 70, 8, 3772000]];
